...
__default_var theme_display_time_format                    '+%H:%M'
...
__default_var __fish_git_prompt_color_branch               yellow
...
function __theme_print_jobs_and_nix
    ...
    if [ $num_jobs -gt 0 -o "$theme_display_jobs_always" = "yes" ]
        print_colored "[$nix_shell_info$num_jobs]" $theme_color_status_jobs
    end
end
